...
<head>
<title>User Rate Advertisement</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
         <h2>User Rating Advertisement Status</h2>
...
<% 
			...
			int count1=0,count2=0,count4=0,rank=0;

    try{
			 			
			String sql="SELECT rate FROM advertisement where id="+one+" ";
			...
			{		
				...
				String sql1="update advertisement set rate='"+cnt+"' where id='"+one+"' ";
				Statement stmt1 = connection.createStatement();
				stmt1.executeUpdate(sql1);
			
		
		%>
<h3><span class="style3">Advertisement Rated Successfully...</span></h3>
<%
		}
		} 
		catch (Exception e) 
		...
		e.printStackTrace();
			...
			%>
			<h2>&nbsp;</h2>
			<p align="right"><a href="U_AdvertisementDetail.jsp?aname=<%=name%>&id=<%=one%>&type=<%=type%>&rank=<%=rank1%>" class="style4">Back</a></p>
      </div>
      <div class="sidebar">

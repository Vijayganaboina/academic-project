...
<head>
<title>User My Advertisement Details</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <h2 align="center"><span class="style6">Advertisement <%=request.getParameter("aname")%> Details</span></h2>
         <h2>
            ...
            <%
					...
					<table border="1" align="center" cellpadding="0" cellspacing="0" >
				 				<tr >
								    <td width="160" rowspan="10" bgcolor="#FFFFFF" ><div class="style22 style5 style7" style="margin:10px 13px 10px 13px;" > 
		                        ...
		                        <input  name="image" type="image" src="images.jsp?value=<%="image"%>&id=<%=i%>" style="width:120px; height:120px;"  />
								  ...
								  <div align="center" class="style10 style7 style8"><strong><span class="style17">Advertisement Category</span> </strong></div></td>
								    <td bgcolor="#FFFFFF"><div align="center" class="style7"><span class="style17" style="color:#000000;"><%= s1%></span></div></td>
				    
				    
				    			<tr>
									<td width="187" height="27" bgcolor="#FFFFFF">
						  		  <div align="center" class="style10 style7 style8"><strong><span class="style17">Advertisement Name</span> </strong></div></td>
							      <td bgcolor="#FFFFFF"><div align="center" class="style7"><span class="style17" style="color:#000000;"><%= s2%></span></div></td>
								</tr>
								<tr>
									<td width="187" height="27" bgcolor="#FFFFFF">
								  <div align="center" class="style10 style7 style8"><strong><span class="style17"><%=s1%> Description </span> </strong></div></td>
							      <td bgcolor="#FFFFFF"><div align="center" class="style7"><span class="style17" style="color:#000000;"><%= s5%></span></div></td>
				    			</tr>
								<tr>
										<td width="187" height="27" bgcolor="#FFFFFF">
								  <div align="center" class="style10 style7 style8"><strong><span class="style17"><%=s1%> Company</span></strong></div></td>
						          <td bgcolor="#FFFFFF"><div align="center" class="style7"><span class="style17" style="color:#000000;"><%= s3%></span></div></td>
								</tr>
								<tr>
								<tr>
										<td width="187" height="27" bgcolor="#FFFFFF">
								  <div align="center" class="style10 style7 style8"><strong><span class="style17">Company Estimation Year </span></strong></div></td>
						          <td bgcolor="#FFFFFF"><div align="center" class="style7"><span class="style17" style="color:#000000;"><%= s4%></span></div></td>
								</tr>
								
								<tr>
										<td width="187" height="27" bgcolor="#FFFFFF">
								  <div align="center" class="style10 style7 style8"><strong><span class="style17"<%=s1%> >Rate </span></strong></div></td>
						          <td bgcolor="#FFFFFF"><div align="center" class="style7"><span class="style17" style="color:#000000;"><%= rank%></span></div></td>
								</tr>
	    ...
	    %></span></div></td>
		  ...
		  <h3 align="center" class="style4 style5">Recommended Details</h3>
        ...
        <tr bgcolor="#99CCCC">
          ...
          <%	
		     ...
		     <h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("myadv")){%>
            <h2 align="right"><a href="U_MyAdvertisements.jsp" class="style4">Back</a></h2>
			<%}

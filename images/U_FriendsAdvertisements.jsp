...
<head>
<title>User All My Friends Advertisement</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <h2><span class="style3">View All Friends Advertisement Details...</span></h2>
        ...
        <tr bgcolor="#99CCCC">
          ...
          <td  width="146" height="34" valign="baseline" style="color: #2c83b0;"><div align="center" class="style22 style7 style8 style6 style15 style3"><strong>Company Name </strong></div></td>
		   <td  width="145" height="34" valign="baseline" style="color: #2c83b0;"><div align="center" class="style22 style7 style8 style6 style15 style3"><strong>Advertisement Image</strong></div></td>
			<td  width="145" height="34" valign="baseline" style="color: #2c83b0;"><div align="center" class="style22 style7 style8 style6 style15 style3"><strong> Recommend </strong></div></td>
						...
						try 
						{
					   		...
					   		while ( rs.next() )
					   		{
								...
								rank1=rank+1;
							 	...
							 	String sql1="select * from req_res where ((requestfrom='"+uname+"'&&requestto='"+s4+"') || (requestfrom='"+s4+"'&&requestto='"+uname+"')) && status='Accepted'";
            ...
            <tr>
              <td  valign="middle" height="0">
			   ...
			   <td  valign="middle" height="0">
                  <div align="center" class="style23 style2">
             			<a href="U_FriendProfile.jsp?type1=<%=s4%>&type=<%="user2"%>"><%=s4%></a>
                </div></td>
			  <td  valign="middle" height="0">
                  <div align="center" class="style23 style2">
              				<%=s1%>
              ...
              <td  valign="middle" height="0">
                  <div align="center" class="style23 style2">
                    <a href="U_AdvertisementDetail.jsp?aname=<%=s2%>&id=<%=j%>&rank=<%=rank1%>&type=<%="frdadv"%>"><%=s2%></a>
              </div></td>
              <td  valign="middle" height="0">
                  <div align="center" class="style23 style2">
             			  <%=s3%>
			   ...
			   <td  valign="middle" height="0">
                  <div align="center" class="style23 style2">
             			 <a href="U_RecommendAdv.jsp?id=<%=j%>"> Recommend To Friend </a>
                </div></td>
			  <%
						}}}}
						connection.close();
				...
				%></table>
          <%	
					if(count==0){out.print("No one Of Your Friends Have Added Advertisement");}%>
